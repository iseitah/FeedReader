    ...
    describe('The menu', function() {
        ...
        var body = document.body;
          ...
          */  
            ...
            //  Test when clicking agin hide the menu
                $('.menu-icon-link').click();
    ...
    /* TODO: Write a new test suite named "Initial Entries" */
         ...
         */
         beforeEach(function(done){
          ...
          it('the loadFeed function is called and completes its work, there is at least a single entry element within the feed container', function() {
